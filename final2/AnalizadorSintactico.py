...
BASE_DIR = os.path.dirname(os.path.abspath(__file__))  # Solo la carpeta actual
...
if __name__ == '__main__':
    tabla_csv_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "table_ll1.csv")
